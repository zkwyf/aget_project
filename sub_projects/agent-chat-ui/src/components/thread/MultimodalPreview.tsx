...
export const MultimodalPreview: React.FC<MultimodalPreviewProps> = ({
  ...
  const filename = block.metadata?.filename || block.metadata?.name || "File";
  return (
    <div
      className={cn(
    ...
    >
      ...
      <span className="truncate text-xs" style={{ wordBreak: "break-all", whiteSpace: "pre-wrap" }}>{String(filename)}</span>
      {removable && (
        <button
          type="button"
